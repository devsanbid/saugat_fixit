...
import controller.WorkerProfileController;
...
loadWorkerProfile();
    ...
    private void update_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_update_btnMouseClicked
        // TODO add your handling code here:
		String firstName = first_name_input.getText().trim();
		...
		boolean success = WorkerProfileController.updatePassword(
				AuthenticationController.getCurrentWorkerId(),
				password
		);
	...
	public void loadWorkerProfile() {
		WorkerProfileController.WorkerProfile profile
				= WorkerProfileController.getWorkerProfile(AuthenticationController.getCurrentWorkerId());
